...
//     Chip shows "1.0.1"; links point at the GitHub release + the tag's docs.
//   - commit  — non-release build past the last tag (every push to main / edge image).
//     CI injects the short SHA (-X main.gitSha=abc1234), so the chip shows "1.0.1+abc1234"
...
//     "1.0.1-dev" and links point at `main` rather than invent a 404-ing commit URL.
...
//
//	release → "1.0.1"; commit → "1.0.1+abc1234"; dev → "1.0.1-dev".
